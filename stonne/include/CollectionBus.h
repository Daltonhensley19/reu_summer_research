...
public:
  ...
  getOutputConnections(); // Get the output connections of all the lines
  Connection* getInputConnectionFromBusLine(
    unsigned int busID,
    unsigned int inputID); // Get a specific inpur from a specific bus line
