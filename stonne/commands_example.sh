...
#-optimize=1
./stonne -FC -M=2 -K=4 -N=2048 -T_K=1 -T_N=1 -num_ms=64 -dn_bw=8

#./stonne -CONV -R=3 -S=3 -C=6 -G=1 -K=6 -N=1 -X=64 -Y=64 -T_R=3 -T_S=3 -T_C=1 -T_G=1 -T_K=1 -T_N=1 -T_X_=1 -T_Y_=1 -num_ms=64 -dn_bw=8
...
#./stonne -SparseGEMM -M=160 -N=80 -K=256 -num_ms=128 -dn_bw=64 -rn_bw=64  -MK_sparsity=80 -KN_sparsity=80 -dataflow=MK_STA_KN_STR
